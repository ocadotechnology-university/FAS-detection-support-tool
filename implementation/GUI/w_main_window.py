...
class Ui_w_MainWindow(object):
    def setupUi(self, w_MainWindow):
        ...
        self.gridLayout.addItem(self.verticalSpacer_2, 21, 0, 1, 5)
        ...
        self.de_birth.setMinimumDateTime(QDateTime(QDate(1900, 9, 14), QTime(0, 24, 0)))
        ...
        self.gridLayout_6.addWidget(self.le_LeftEyeMMChart, 1, 1, 1, 2)
        ...
        self.gridLayout_6.addWidget(self.le_RightEyeMMChart, 2, 1, 1, 2)
